...
from components.DeepLab_V3plus import resnet_v1_beta
from components.DeepLab_V3plus import xception
from tensorflow.contrib.slim.nets import resnet_utils
from components.MobileNet import MobileNet_v2 as mobilenet_v2
